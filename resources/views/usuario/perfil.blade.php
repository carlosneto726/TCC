...
<div class="container">
    ...
    <div class="rounded mt-5 shadow">
        <form class="row g-3 p-3 needs-validation" method="POST" action="{{url("/usuario/atualizar")}}">
            @csrf
            @method("POST")
            <div class="mb-3">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="text" name="cep" class="form-control" id="CEP" value="{{$usuario->cep}}" placeholder="Digite o seu CEP" required>
            </div>

            <div class="mb-3 col-md-6">
                <label class="form-check-label" for="endereco">Endereço</label>
                <input type="text" name="endereco" class="form-control" id="endereco" value="{{$usuario->endereco}}" placeholder="Digite o seu endereço" required>
            </div>
